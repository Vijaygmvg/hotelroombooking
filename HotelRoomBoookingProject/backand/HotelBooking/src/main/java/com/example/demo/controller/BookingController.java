...
public class BookingController {
	...
	public ResponseEntity<?> saveBoooking(@PathVariable Long roomId,
			 @RequestBody BookedRoom bookingRequest,@RequestParam Long paymentId) throws SQLException{
		    System.out.println("the booking room is came and hitted "+paymentId);
		try {
			String confirmationCode=bookingService.saveBooking(roomId,bookingRequest,paymentId);
	...
	public ResponseEntity<?> getBookingsByUserId(@PathVariable("email") String email){
		...
		System.out.println("yes it is not having issues "+email+bookedRooms.size());
